const RegiContent = [
  ...
  },
  {
    ...
    sub: [
      'a.) Use valid email',
      'b.) Password must contain small and capital letters, and numbers ',
      'c.) Change your currency.(e.g. PHP if you’re from the Philippines) ',
      'd.) Promo Code: 209088',
      'e.) Check the terms and agreement',
    ],
  },
  {
    id: 4,
    ...
    sub: [
      'Check the email you provided for the validation link and click to complete the sign up process.',
    ],
  },
  {
    id: 5,
